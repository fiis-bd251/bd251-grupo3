...
### Caso de Uso 5: Visualizar Inventario en Tiempo Real

| **Campo**             | **Descripción**                                                                |
|-------------------|-----------------------------------------------------------------------------|
| **Objetivo**       | Consultar stock disponible, reservado y comprometido.                      |
| **Descripción**    | Permite al usuario consultar el estado actualizado del inventario.         |
| **Actor Primario** | Supervisor / Operador / Auditor                                           |
| **Actor Secundario** | Sistema de gestión de almacenes                                          |
| **Precondiciones** | Acceso autorizado al sistema.                                              |
| **Flujo de Eventos** | 1. Acceder al módulo. <br> 2. Filtrar por producto, zona, lote o estado. <br> 3. Consultar detalle. |
| **Postcondición** | Usuario visualiza información actualizada del stock.                       |

---

### Caso de Uso 6: Notificar Traslado entre Almacenes

| **Campo**            | **Descripción**                                                                 |
|-------------------|-----------------------------------------------------------------------------|
| **Objetivo**       | Notificar el traslado de productos entre almacenes.                        |
